...
1. **Backend cannot reach PostgreSQL**
   ...
   - Confirm the firewall rule named _"PostgreSQL 5432 desde Docker"_ allows the relevant Docker NAT subnet.
...
- Default admin user: `admin / admin123` (update in _Configuración → Usuarios_).
